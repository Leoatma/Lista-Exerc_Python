...
pesoPeixes = float(input("Quantos kg de peixe foram pescados? "))

excesso = pesoPeixes - 50
multa = 4.0 * excesso

print(f'João, você pescou um excedente de {excesso:.1f}kg. Por isso, deverá pagar uma multa de {multa:.2f} reais.')
